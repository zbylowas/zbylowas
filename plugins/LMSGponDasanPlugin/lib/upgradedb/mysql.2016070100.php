...
$this->Execute("INSERT INTO uiconfig (section, var, value, description, disabled) VALUES ('gpon-dasan', 'xml_provisioning_filename', '', 'szablon nazwy pliku w którym zapisywane są konfiguracje końcówek używane przy ich provisioningu', 1)");
$this->Execute("INSERT INTO uiconfig (section, var, value, description, disabled) VALUES ('gpon-dasan', 'xml_provisioning_template', '', 'ścieżka do pliku z szablonem pliku xml używanym przy provisioningu xml końcówek', 1)");
...
$this->Execute("ALTER TABLE gpononu ADD COLUMN xmlprovisioning tinyint(4) DEFAULT 0");
