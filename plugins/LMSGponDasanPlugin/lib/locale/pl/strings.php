...
$_LANG['ONU Port Count:'] = 'Liczba portów ONU:';
...
$_LANG['Enter XML configuration template contents (optional)'] = 'Wprowadź zawartość szalonu konfiguracji XML (opcjonalnie)';
