...
{
	$SESSION->redirect('?m=gpondasanonutvlist');
}		
...
if($_GET['is_sure']!=1)
    {
	    ...
	    $body .= '<P><A HREF="?m=gpondasanonutvlist&id='.$_GET['id'].'&is_sure=1">'.trans('Yes, I am sure.').'</A></P>';
    }else{
	    header('Location: ?m=gpondasanonutvlist');
